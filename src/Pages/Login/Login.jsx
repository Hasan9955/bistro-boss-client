...
const Login = () => {
    ...
    return (
        <div className="hero " style={{ backgroundImage: `url(${bgImg})` }}>
            <div className="hero-content shadow-2xl md:m-20 py-10 flex flex-col lg:flex-row justify-center items-center" style={{ backgroundImage: `url(${bgImg})` }}>
                <div className=" ">
                    ...
                    <form onSubmit={handleLogin} className="md:card-body">
                       <h2 className='text-4xl font-extrabold text-center'>Login</h2>
                        ...
                        <LoadCanvasTemplate />
                            ...
                            <p onClick={handleCaptcha} className='link text-blue-700 mt-2'>Verify Captcha</p>
                        </div>
